...
# Title: GPS L1 C/A Signal Analyzer
# Author: gui_sdr_gps_sim
# Description: Analyze GPS L1 C/A output from gui_sdr_gps_sim via a second HackRF in RX mode
...
class gps_l1_analyzer(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "gps_l1_analyzer")
        ...
        self._vga_gain_range = qtgui.Range(0, 62, 2, 30, 200)
        ...
        self._lna_gain_range = qtgui.Range(0, 40, 8, 16, 200)
        ...
        self.top_layout.addWidget(self._lna_gain_win)
